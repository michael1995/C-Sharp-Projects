<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="ChocoMamboWebApplication.Product" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_Master" runat="server">
    ...
    <asp:Table ID="tbl_Product" runat="server">
        <asp:TableRow>
            <asp:TableCell>
