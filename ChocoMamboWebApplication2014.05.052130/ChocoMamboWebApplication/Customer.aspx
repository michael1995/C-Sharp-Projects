<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="Customer.aspx.cs" Inherits="ChocoMamboWebApplication.CustomerList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_Master" runat="server">
    ...
    <asp:Table ID="tbl_customerDetails" runat="server">
        <asp:TableRow>
            <asp:TableCell>
         ...
         <asp:TableRow>
            <asp:TableCell>
                    <asp:Label ID="Label8" runat="server" Text="Label">Sales Manager: </asp:Label>
            </asp:TableCell>
            <asp:TableCell>
                <asp:TextBox ID="txt_SalesManager" runat="server" ></asp:TextBox>
            </asp:TableCell>
        </asp:TableRow>
         <asp:TableRow>
            <asp:TableCell>
