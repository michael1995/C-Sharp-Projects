...
namespace ChocoMambo
{
    public partial class frmParent : Form
    {
        ...
        {
            ToolStripItem[] MnuArray = new ToolStripItem[3] { mnuFile, mnuLogout, mnuView };
            if (AccessRights[pStrFormName].ToString() == "Deny")
            {
                disableMenuButtons(MnuArray); mnuUser.Enabled = true;
            }
            else if (AccessRights[pStrFormName].ToString() == "Read")
            {
                disableMenuButtons(MnuArray); mnuUser.Enabled = true; mnuView.Enabled = true; mnuAccessLevels.Enabled = false;
            }
            else if (AccessRights[pStrFormName].ToString() == "Write")
            {
                enableMenuButtons(MnuArray); mnuView.Enabled = false; mnuAddAccessLevels.Enabled = false;
            }
            else
            {
        ...
        {
            frmView employeeViewFrm = new frmView("qryEmployeeActive", _dtb, 1);
        ...
        {
            frmView customerViewFrm = new frmView("qryCustomerActive", _dtb, 2);
        ...
        {
            frmView orderViewFrm = new frmView("qryOrdersActive", _dtb, 3);
            orderViewFrm.Text = "View Orders" + ++_intCounter;
        ...
        {
            frmView productViewFrm = new frmView("qryProductActive", _dtb, 4);
        ...
        {
            frmView supplierViewFrm = new frmView("qrySupplierActive", _dtb, 5);
            supplierViewFrm.Text = "View Suppliers" + ++_intCounter;
        ...
        {
            frmView supplierpurchaseViewFrm = new frmView("qrySupplierPurchaseActive", _dtb, 6);
        ...
        {
            frmView rawingredientsViewFrm = new frmView("qryRawIngredientsActive", _dtb, 7);
        ...
        {
            frmView branchViewFrm = new frmView("qryBranchActive", _dtb, 8);
            branchViewFrm.Text = "View Branchs" + ++_intCounter;
            branchViewFrm.MdiParent = this;
            branchViewFrm.Show();
        }

        private void mnuAddAccessLevels_Click(object sender, EventArgs e)
        {
            frmPermissions accesslevelsFrm = new frmPermissions();
            accesslevelsFrm.Text = "Access Levels Form" + ++_intCounter;
            accesslevelsFrm.MdiParent = this;
            accesslevelsFrm.Show();
        }

        private void mnuAccessLevels_Click(object sender, EventArgs e)
        {
            frmView accesslevelViewFrm = new frmView("qryAccessLevels", _dtb, 9);
            accesslevelViewFrm.Text = "View Access Levels" + ++_intCounter;
            accesslevelViewFrm.MdiParent = this;
            accesslevelViewFrm.Show();
        }
