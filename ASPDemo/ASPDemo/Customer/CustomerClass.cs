...
namespace ASPDemo.Customer
{
    public class CustomerClass
    {
        ...
        public CustomerClass(long pLongID)
        {
            _lngPKID = pLongID;
            loadDataSet();
            assignFields();
        ...
        /// <summary>
        /// Pre-condition:  true
        /// Post-condition: Will return the qryEmployee
        /// Description:    This method will return the qryEmployee to be used as a data source for a combo box.
        /// </summary>
        /// <returns>DataTable qryEmployee</returns>
