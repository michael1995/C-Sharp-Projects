...
namespace ASPDemo.Order
{
    public class OrderLineClass
    {
        ...
        public OrderLineClass(DataSet pDataSet, long pLongID)
        {
            _dst = pDataSet;
            _lngFKID = pLongID;
            loadDataSet();
        ...
        ///                 SELECT tblOrderLines.OrderLineID, tblProducts.ProductName, tblOrderLines.ProductPrice, tblOrderLines.OrderLineQty, 
        //                  tblOrderLines.OrderLineSubTotal, tblOrderLines.ProductID, tblOrderLines.OrderNumber
